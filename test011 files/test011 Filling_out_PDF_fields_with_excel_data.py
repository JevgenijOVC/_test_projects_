...
if __name__ == '__main__':
    ...
    for j, rows in data.iterrows():
        ...
        field_dictionary_1 = {"name": str(rows['Pavadinimas']),
                              "material": rows['Medžiaga'],
                              "description": rows['Pastaba'],
                              "drawing number": rows['Žymėjimas'],
                              "amount": rows['Kiekis n-vnt.'],
                              "thickness": rows['Storis'],
                              "width": rows['Plotis'],
                              "length": rows['Ilgis'],
                              }
